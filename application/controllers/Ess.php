...
class Ess extends CI_Controller {
	...
	public function inputssdi()
	{
		if ( $this->logged && $this->role == '10' || $this->role == '20')
		{
			$this->content['page'] = 'ess';
			$this->content['js'] = '/assets/js/action/ess/inputssdi.js';
			$this->twig->display('admin/ess/inputssdi.html', $this->content);
		}else{
			redirect("dashboard");
		}
	}
