...
$route['^(dashboard|dashboard1)(/:any)?$'] = "sys/$0";
$route['^(submitkegiatan|loadkegiatan|actionkegiatan|loadindikator|saveindikator|loadso|submitso|actionindikator|getDash|actionkalibrasi|loadess)(/:any)?$'] = "json/$0";
$route['^(so|inputso|kalibrasi)(/:any)?$'] = "view/$0";
$route['^(inputssdi)(/:any)?$'] = "ess/$0";
